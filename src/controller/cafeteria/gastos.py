from flask import (
    abort, render_template, Blueprint, flash, g, redirect, request, session, url_for
)

from src.model.repository.repo_gasto import *
from src.model.repository.repo_sucursal import get_all_sucursales
...
#UPDATE PRECIO
@gastos.route('/editar-gasto/<int:id_gasto>', methods=('GET', 'POST'))
@requiere_inicio_sesion
@admin
...
#DELETE PRECIO
@gastos.route('/eliminar-gasto/<int:id_gasto>')
@requiere_inicio_sesion
@admin
